namespace EyePatch.Core.Mvc.Resources
{
    ...
    {
        public static Resource jQuery = new Resource("//ajax.googleapis.com/ajax/libs/jquery/1.6.1/jquery.min.js",
                                                     MatchMode.FileName);

        public static Resource jQueryUI =
            new Resource("//ajax.googleapis.com/ajax/libs/jqueryui/1.8.14/jquery-ui.min.js", MatchMode.FileName);

        public static Resource jQueryValidate =
            new Resource("//ajax.aspnetcdn.com/ajax/jquery.validate/1.8/jquery.validate.js", MatchMode.FileName);

        public static Resource jQueryValidateUnobtrusive =
            new Resource("//ajax.aspnetcdn.com/ajax/mvc/3.0/jquery.validate.unobtrusive.js", MatchMode.FileName);
