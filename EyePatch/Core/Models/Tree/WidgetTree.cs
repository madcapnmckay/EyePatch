...
namespace EyePatch.Core.Models.Tree
{
    public class WidgetTree : NKnockoutUI.Tree.Tree
    {
        ...
        public void AddWidgetGroup(Entity.Plugin plugin)
        {
        ...
        private class WidgetTreeDefaults
        {
            ...
            public Behavior Widget
            {
                get
                {
                    return new Behavior { IsDraggable = true, IsDropTarget = false, CanAddChildren = false, ConnectToSortable = ".content-area", DragCursor = "move", DragCursorAt = new { top = -12, left = -20 }, DragHelper = "ep.tree.widget.dragHelper" };
                }
            }
        }
    }
